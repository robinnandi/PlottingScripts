...
samples = [Data_Sideband_Control, Data_Sideband_Selected]
out_folder = "plots/SeleAnti-Sideband-Data/" 
histograms = [
...
#intlumi = 1100.
intlumi = -1
DoPlotting([samples, histograms, files_folder, out_folder, formats, intlumi])
